package io.github.landwarderer.mangablaze.reader.domain
...
import io.github.landwarderer.mangablaze.core.parser.CachingMangaRepository
...
import io.github.landwarderer.mangablaze.core.ui.image.TrimTransformation
import io.github.landwarderer.mangablaze.core.util.FileSize
import io.github.landwarderer.mangablaze.core.util.MimeTypes
import io.github.landwarderer.mangablaze.core.util.ext.URI_SCHEME_ZIP
import io.github.landwarderer.mangablaze.core.util.ext.cancelChildrenAndJoin
import io.github.landwarderer.mangablaze.core.util.ext.compressToPNG
import io.github.landwarderer.mangablaze.core.util.ext.ensureRamAtLeast
import io.github.landwarderer.mangablaze.core.util.ext.ensureSuccess
import io.github.landwarderer.mangablaze.core.util.ext.getCompletionResultOrNull
import io.github.landwarderer.mangablaze.core.util.ext.isFileUri
import io.github.landwarderer.mangablaze.core.util.ext.isNotEmpty
import io.github.landwarderer.mangablaze.core.util.ext.isPowerSaveMode
import io.github.landwarderer.mangablaze.core.util.ext.isZipUri
import io.github.landwarderer.mangablaze.core.util.ext.lifecycleScope
...
import io.github.landwarderer.mangablaze.core.util.ext.ramAvailable
import io.github.landwarderer.mangablaze.core.util.ext.toMimeType
import io.github.landwarderer.mangablaze.core.util.ext.use
import io.github.landwarderer.mangablaze.core.util.ext.withProgress
import io.github.landwarderer.mangablaze.core.util.progress.ProgressDeferred
import io.github.landwarderer.mangablaze.download.ui.worker.DownloadSlowdownDispatcher

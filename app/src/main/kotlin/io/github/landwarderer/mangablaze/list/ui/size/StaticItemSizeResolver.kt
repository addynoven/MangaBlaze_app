...
class StaticItemSizeResolver(
	...
	private var textAppearanceResId = R.style.TextAppearance_MangaBlaze_GridTitle
	...
	override fun attachToView(
		...
		if (widthThreshold == -1) {
			...
			textAppearanceResId = if (cellWidth < widthThreshold) {
				R.style.TextAppearance_MangaBlaze_GridTitle_Small
			} else {
				R.style.TextAppearance_MangaBlaze_GridTitle
			}
		}
		if (textView != null) {

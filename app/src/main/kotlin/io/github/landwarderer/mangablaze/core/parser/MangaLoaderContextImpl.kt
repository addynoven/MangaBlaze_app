...
import io.github.landwarderer.mangablaze.core.network.webview.WebViewExecutor
import io.github.landwarderer.mangablaze.core.prefs.SourceSettings
...
import io.github.landwarderer.mangablaze.core.network.webview.WebViewRequestInterceptorExecutor
...
class MangaLoaderContextImpl @Inject constructor(
    ...
    override suspend fun interceptWebViewRequests(
        ...
        val config = io.github.landwarderer.mangablaze.core.network.webview.InterceptionConfig(
            timeoutMs = timeout,
            maxRequests = 100,
    ...
    override suspend fun interceptWebViewRequests(
        ...
        val appConfig = io.github.landwarderer.mangablaze.core.network.webview.InterceptionConfig(

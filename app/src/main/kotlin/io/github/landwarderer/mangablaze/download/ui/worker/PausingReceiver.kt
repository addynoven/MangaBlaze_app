...
import io.github.landwarderer.mangablaze.core.util.ext.toUUIDOrNull
...
class PausingReceiver(
	...
	companion object {
		...
		private const val ACTION_PAUSE = "io.github.landwarderer.mangablaze.download.PAUSE"
		private const val ACTION_RESUME = "io.github.landwarderer.mangablaze.download.RESUME"
		private const val ACTION_SKIP = "io.github.landwarderer.mangablaze.download.SKIP"
		private const val ACTION_SKIP_ALL = "io.github.landwarderer.mangablaze.download.SKIP_ALL"

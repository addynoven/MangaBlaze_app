...
import io.github.landwarderer.mangablaze.mihon.parsers.ContentParser
import io.github.landwarderer.mangablaze.mihon.parsers.InternalParsersApi
import io.github.landwarderer.mangablaze.mihon.parsers.config.ConfigKey
import io.github.landwarderer.mangablaze.mihon.parsers.config.ContentSourceConfig
import io.github.landwarderer.mangablaze.mihon.parsers.model.Content
import io.github.landwarderer.mangablaze.mihon.parsers.model.ContentPage
...
import io.github.landwarderer.mangablaze.mihon.parsers.model.Favicons
import io.github.landwarderer.mangablaze.mihon.parsers.model.SortOrder
import io.github.landwarderer.mangablaze.mihon.parsers.model.search.ContentSearchQuery
import io.github.landwarderer.mangablaze.mihon.parsers.model.search.ContentSearchQueryCapabilities
import io.github.landwarderer.mangablaze.mihon.parsers.network.OkHttpWebClient
import io.github.landwarderer.mangablaze.mihon.parsers.network.WebClient
import io.github.landwarderer.mangablaze.mihon.parsers.util.FaviconParser
import io.github.landwarderer.mangablaze.mihon.parsers.util.LinkResolver
import io.github.landwarderer.mangablaze.mihon.parsers.util.RelatedContentFinder
import io.github.landwarderer.mangablaze.mihon.parsers.util.convertToContentListFilter
import io.github.landwarderer.mangablaze.mihon.parsers.util.toAbsoluteUrl
import io.github.landwarderer.mangablaze.mihon.parsers.util.toContentSearchQueryCapabilities
...
public abstract class AbstractContentParser @InternalParsersApi constructor(
	...
	protected open val userAgentKey: ConfigKey.UserAgent = try {
		...
		ConfigKey.UserAgent(io.github.landwarderer.mangablaze.mihon.parsers.network.UserAgents.CHROME_MOBILE)
	}

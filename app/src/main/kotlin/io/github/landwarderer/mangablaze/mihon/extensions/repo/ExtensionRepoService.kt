package io.github.landwarderer.mangablaze.mihon.extensions.repo
...
import io.github.landwarderer.mangablaze.core.prefs.GitHubMirror
import io.github.landwarderer.mangablaze.mihon.MihonExtensionLoader
...
class ExtensionRepoService @Inject constructor(
	...
	suspend fun fetchRepoDetails(baseUrl: String, type: ExternalExtensionType): ExternalExtensionRepo {
		if (type == ExternalExtensionType.IREADER || type == ExternalExtensionType.JAR) {
			...
			val derived = deriveRepoName(baseUrl, if (type == ExternalExtensionType.IREADER) "IReader" else "MangaBlaze")
			val repoName = if (type == ExternalExtensionType.IREADER) "IReader: $derived" else "MangaBlaze: $derived"

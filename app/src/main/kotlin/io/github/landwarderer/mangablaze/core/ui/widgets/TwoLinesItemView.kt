...
import io.github.landwarderer.mangablaze.core.util.ext.getDrawableCompat
import io.github.landwarderer.mangablaze.core.util.ext.resolveDp
import io.github.landwarderer.mangablaze.core.util.ext.textAndVisible
import io.github.landwarderer.mangablaze.databinding.ViewTwoLinesItemBinding
...
class TwoLinesItemView @JvmOverloads constructor(
	...
	init {
		...
		context.withStyledAttributes(
			...
			defStyleRes = R.style.Widget_MangaBlaze_TwoLinesItemView,
		) {

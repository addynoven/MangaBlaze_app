...
import io.github.landwarderer.mangablaze.alternatives.ui.AlternativesActivity
import io.github.landwarderer.mangablaze.backups.ui.backup.BackupDialogFragment
import io.github.landwarderer.mangablaze.backups.ui.restore.RestoreDialogFragment
import io.github.landwarderer.mangablaze.bookmarks.ui.AllBookmarksActivity
import io.github.landwarderer.mangablaze.browser.BrowserActivity
import io.github.landwarderer.mangablaze.browser.cloudflare.CloudFlareActivity
import io.github.landwarderer.mangablaze.core.exceptions.CloudFlareProtectedException
import io.github.landwarderer.mangablaze.core.image.CoilMemoryCacheKey
...
import io.github.landwarderer.mangablaze.core.model.appUrl
...
import io.github.landwarderer.mangablaze.core.model.parcelable.ParcelableMangaListFilter
...
import io.github.landwarderer.mangablaze.core.prefs.ReaderMode
import io.github.landwarderer.mangablaze.core.prefs.TriStateOption
import io.github.landwarderer.mangablaze.core.ui.dialog.BigButtonsAlertDialog
import io.github.landwarderer.mangablaze.core.ui.dialog.ErrorDetailsDialog
import io.github.landwarderer.mangablaze.core.ui.dialog.buildAlertDialog
import io.github.landwarderer.mangablaze.core.util.ext.connectivityManager
import io.github.landwarderer.mangablaze.core.util.ext.findActivity
import io.github.landwarderer.mangablaze.core.util.ext.getThemeDrawable
import io.github.landwarderer.mangablaze.core.util.ext.printStackTraceDebug
import io.github.landwarderer.mangablaze.core.util.ext.toFileOrNull
import io.github.landwarderer.mangablaze.core.util.ext.toUriOrNull
import io.github.landwarderer.mangablaze.core.util.ext.withArgs
import io.github.landwarderer.mangablaze.details.ui.DetailsActivity
import io.github.landwarderer.mangablaze.details.ui.pager.ChaptersPagesSheet
import io.github.landwarderer.mangablaze.details.ui.related.RelatedMangaActivity
import io.github.landwarderer.mangablaze.details.ui.scrobbling.ScrobblingInfoSheet
import io.github.landwarderer.mangablaze.download.ui.dialog.DownloadDialogFragment
import io.github.landwarderer.mangablaze.download.ui.list.DownloadsActivity
import io.github.landwarderer.mangablaze.favourites.ui.FavouritesActivity
import io.github.landwarderer.mangablaze.favourites.ui.categories.FavouriteCategoriesActivity
import io.github.landwarderer.mangablaze.favourites.ui.categories.edit.FavouritesCategoryEditActivity
import io.github.landwarderer.mangablaze.favourites.ui.categories.select.FavoriteDialog
import io.github.landwarderer.mangablaze.filter.ui.FilterCoordinator
import io.github.landwarderer.mangablaze.filter.ui.sheet.FilterSheetFragment
import io.github.landwarderer.mangablaze.filter.ui.tags.TagsCatalogSheet
import io.github.landwarderer.mangablaze.history.ui.HistoryActivity
import io.github.landwarderer.mangablaze.image.ui.ImageActivity
import io.github.landwarderer.mangablaze.list.ui.config.ListConfigBottomSheet
import io.github.landwarderer.mangablaze.list.ui.config.ListConfigSection
import io.github.landwarderer.mangablaze.local.ui.ImportDialogFragment
import io.github.landwarderer.mangablaze.local.ui.info.LocalInfoDialog
import io.github.landwarderer.mangablaze.main.ui.MainActivity
import io.github.landwarderer.mangablaze.main.ui.welcome.WelcomeSheet
import io.github.landwarderer.mangablaze.reader.ui.colorfilter.ColorFilterConfigActivity
import io.github.landwarderer.mangablaze.reader.ui.config.ReaderConfigSheet
import io.github.landwarderer.mangablaze.scrobbling.common.domain.model.ScrobblerService
import io.github.landwarderer.mangablaze.scrobbling.common.ui.config.ScrobblerConfigActivity
import io.github.landwarderer.mangablaze.scrobbling.common.ui.selector.ScrobblingSelectorSheet
import io.github.landwarderer.mangablaze.search.domain.SearchKind
import io.github.landwarderer.mangablaze.search.ui.MangaListActivity
import io.github.landwarderer.mangablaze.search.ui.multi.SearchActivity
import io.github.landwarderer.mangablaze.settings.SettingsActivity
import io.github.landwarderer.mangablaze.settings.about.AppUpdateActivity
import io.github.landwarderer.mangablaze.settings.override.OverrideConfigActivity
import io.github.landwarderer.mangablaze.settings.reader.ReaderTapGridConfigActivity
import io.github.landwarderer.mangablaze.settings.sources.auth.SourceAuthActivity
import io.github.landwarderer.mangablaze.settings.sources.catalog.SourcesCatalogActivity
import io.github.landwarderer.mangablaze.settings.sources.extension.ExtensionDownloaderActivity
import io.github.landwarderer.mangablaze.settings.storage.MangaDirectorySelectDialog
import io.github.landwarderer.mangablaze.settings.storage.directories.MangaDirectoriesActivity
import io.github.landwarderer.mangablaze.settings.tracker.categories.TrackerCategoriesConfigSheet
import io.github.landwarderer.mangablaze.stats.ui.StatsActivity
import io.github.landwarderer.mangablaze.stats.ui.sheet.MangaStatsSheet
import io.github.landwarderer.mangablaze.suggestions.ui.SuggestionsActivity
import io.github.landwarderer.mangablaze.tracker.ui.updates.UpdatesActivity

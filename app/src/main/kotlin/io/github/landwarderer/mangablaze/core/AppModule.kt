package io.github.landwarderer.mangablaze.core
...
import io.github.landwarderer.mangablaze.backups.domain.BackupObserver
import io.github.landwarderer.mangablaze.core.db.MangaDatabase
import io.github.landwarderer.mangablaze.core.exceptions.resolve.CaptchaHandler
import io.github.landwarderer.mangablaze.core.image.AvifImageDecoder
import io.github.landwarderer.mangablaze.core.image.CbzFetcher
import io.github.landwarderer.mangablaze.core.image.MangaSourceHeaderInterceptor
...
import io.github.landwarderer.mangablaze.core.os.AppShortcutManager
import io.github.landwarderer.mangablaze.core.os.NetworkState
import io.github.landwarderer.mangablaze.core.parser.MangaLoaderContextImpl
import io.github.landwarderer.mangablaze.core.parser.favicon.FaviconFetcher
import io.github.landwarderer.mangablaze.core.prefs.AppSettings
import io.github.landwarderer.mangablaze.core.ui.image.CoilImageGetter
import io.github.landwarderer.mangablaze.core.ui.util.ActivityRecreationHandle

import io.github.landwarderer.mangablaze.core.util.FileSize
import io.github.landwarderer.mangablaze.core.util.ext.connectivityManager
import io.github.landwarderer.mangablaze.core.util.ext.isLowRamDevice
import io.github.landwarderer.mangablaze.details.ui.pager.pages.MangaPageFetcher
import io.github.landwarderer.mangablaze.details.ui.pager.pages.MangaPageKeyer
import io.github.landwarderer.mangablaze.local.data.CacheDir
import io.github.landwarderer.mangablaze.local.data.FaviconCache
...
import io.github.landwarderer.mangablaze.main.domain.CoverRestoreInterceptor
import io.github.landwarderer.mangablaze.main.ui.protect.AppProtectHelper
import io.github.landwarderer.mangablaze.main.ui.protect.ScreenshotPolicyHelper
import org.koitharu.kotatsu.parsers.MangaLoaderContext
import io.github.landwarderer.mangablaze.search.ui.MangaSuggestionsProvider
import io.github.landwarderer.mangablaze.sync.domain.SyncController
import io.github.landwarderer.mangablaze.widget.WidgetUpdater

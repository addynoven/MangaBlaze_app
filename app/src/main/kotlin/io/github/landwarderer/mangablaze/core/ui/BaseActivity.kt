...
import io.github.landwarderer.mangablaze.core.ui.util.ActionModeDelegate
import io.github.landwarderer.mangablaze.core.util.ext.isWebViewUnavailable
...
abstract class BaseActivity<B : ViewBinding> :
	...
	override fun onCreate(savedInstanceState: Bundle?) {
		...
		if (isAmoledTheme) {
			setTheme(R.style.ThemeOverlay_MangaBlaze_Amoled)
		}

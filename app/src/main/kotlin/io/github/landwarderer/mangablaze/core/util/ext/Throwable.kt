...
import io.github.landwarderer.mangablaze.core.exceptions.BadBackupFormatException
import io.github.landwarderer.mangablaze.core.exceptions.CaughtException
...
import io.github.landwarderer.mangablaze.core.exceptions.EmptyMangaException
import io.github.landwarderer.mangablaze.core.exceptions.IncompatiblePluginException
import io.github.landwarderer.mangablaze.core.exceptions.InteractiveActionRequiredException
import io.github.landwarderer.mangablaze.core.exceptions.NoDataReceivedException
import io.github.landwarderer.mangablaze.core.exceptions.NonFileUriException
import io.github.landwarderer.mangablaze.core.exceptions.ProxyConfigException
import io.github.landwarderer.mangablaze.core.exceptions.SyncApiException
import io.github.landwarderer.mangablaze.core.exceptions.UnsupportedFileException
import io.github.landwarderer.mangablaze.core.exceptions.UnsupportedSourceException
import io.github.landwarderer.mangablaze.core.exceptions.WrapperIOException
import io.github.landwarderer.mangablaze.core.exceptions.WrongPasswordException
...
import io.github.landwarderer.mangablaze.scrobbling.common.domain.ScrobblerAuthRequiredException
import java.io.File
...
fun Throwable.report(silent: Boolean = false) {
	...
	if (!silent) {
		...
		Log.e("MangaBlaze", "Exception reported", exception)
	} else if (!BuildConfig.DEBUG) {
		exception.printStackTrace()
		Log.w("MangaBlaze", "Silent exception reported", exception)
	}
}
...
fun FileNotFoundException.parseMessage(resources: Resources): String? {
    ...
    /storage/0000-0000/Android/media/d1f08350-0c25-460b-8f50-008e49de3873.jpg.tmp: open failed: EROFS (Read-only file system)
     /storage/emulated/0/Android/data/io.github.landwarderer.mangablaze/cache/pages/fe06e192fa371e55918980f7a24c91ea.jpg: open failed: ENOENT (No such file or directory)
     /storage/0000-0000/Android/data/io.github.landwarderer.mangablaze/files/manga/e57d3af4-216e-48b2-8432-1541d58eea1e.tmp (I/O error)
     */
    val groups = FNFE_MESSAGE_REGEX.matchEntire(message ?: return null)?.groupValues ?: return null

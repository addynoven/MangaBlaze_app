package io.github.landwarderer.mangablaze.suggestions.ui
...
import io.github.landwarderer.mangablaze.core.exceptions.CloudFlareException
import io.github.landwarderer.mangablaze.core.exceptions.resolve.CaptchaHandler
import io.github.landwarderer.mangablaze.core.model.distinctById
import io.github.landwarderer.mangablaze.core.model.getLocale
...
import io.github.landwarderer.mangablaze.core.util.ext.awaitUniqueWorkInfoByName
...
import io.github.landwarderer.mangablaze.core.util.ext.flatten
...
import io.github.landwarderer.mangablaze.core.util.ext.sanitize
import io.github.landwarderer.mangablaze.core.util.ext.takeMostFrequent
import io.github.landwarderer.mangablaze.core.util.ext.toBitmapOrNull
import io.github.landwarderer.mangablaze.core.util.ext.trySetForeground
...
import io.github.landwarderer.mangablaze.settings.work.PeriodicWorkScheduler
import io.github.landwarderer.mangablaze.suggestions.domain.MangaSuggestion
import io.github.landwarderer.mangablaze.suggestions.domain.SuggestionRepository
...
class SuggestionsWorker @AssistedInject constructor(
	...
	private companion object {
		...
		const val GROUP_SUGGESTION = "io.github.landwarderer.mangablaze.SUGGESTIONS"

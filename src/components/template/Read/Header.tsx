...
const Header = () => {
  ...
  const { isShowHeader, isShowMenu, pageIndex, totalPages } = useAppSelector(
    (state) => state.theme
  )
            ...
            <div id="nav-menu">
              <ul>
                <li>
                  ...
                  <ul className="c1">
                    <li>
                      <Link title="Manga mangas" href="/type/manga">
                        Manga
                      </Link>
                    </li>
                    <li>
                      <Link title="One-Shot mangas" href="/type/one-shot">
                        One-Shot
                      </Link>
                    </li>
                    <li>
                      <Link title="Doujinshi mangas" href="/type/doujinshi">
                        Doujinshi
                      </Link>
                    </li>
                    <li>
                      <Link title="Novel mangas" href="/type/novel">
                        Novel
                      </Link>
                    </li>
                    <li>
                      <Link title="Manhwa mangas" href="/type/manhwa">
                        Manhwa
                      </Link>
                    </li>
                    <li>
                      <Link title="Manhua mangas" href="/type/manhua">
                        Manhua
                      </Link>
                    </li>
                  </ul>
                ...
                <li>
                  ...
                  <ul className="lg">
                    {genres.map((genre, index) => (
                      <li key={index}>
                        <Link title={genre.title} href={genre.link}>
                          {genre.title}
                        </Link>
                      </li>
                    ))}
                ...
                <li>
                  <Link href="newest" title="New Release Manga">
                    Newest
                  </Link>
                </li>
                <li>
                  <Link href="updated" title="Recently Updated Manga">
                    Updated
                  </Link>
                </li>
                <li>
                  <Link href="added" title="Recently Added Manga">
                    Added
                  </Link>
                </li>
                <li>
